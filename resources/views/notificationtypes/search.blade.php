...
@section('content')
    ...
    <form action="{{ route('notificationtypes.search') }}" method="POST" class="ajaxSearch">
    ...
    <a href="{{URL::to('notificationtypes/create')}}"><button class="tablebutton" type="submit">Post a new notificationtype</button></a>
