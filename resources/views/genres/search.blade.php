...
@section('content')
    ...
    <form action="{{ route('genres.search') }}" method="POST" class="ajaxSearch">
    ...
    <a href="{{URL::to('genres/create')}}"><button class="tablebutton" type="submit">Post a new genre</button></a>
